...
public class HomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements HomeHolder.OnItemClickListener{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_home_fragment_item,parent,false);
